...
int serializeme()
{
    ...
    std::cout << "proxy re-encyrpt" <<std::endl;

    auto myringsize = cryptoContext->GetRingDimension();
    std::cout << "Alice can encrypt " << myringsize * 2 << " bytes of data" << std::endl;
    ...
    reencryptionKey12 = cryptoContext->ReKeyGen(keyPair.secretKey, keyPair2.publicKey);
   ...
   //}
    ...
    ////////////////////////////////////////////////////////////
    vecCT ct1 = etxt;
    auto ct2 = cryptoContext->ReEncrypt(ct1[0], reencryptionKey12);
...
int proxy_reenc(){
    std::cout << "attemp proxy re-encryption" << std::endl;
    return 1;
